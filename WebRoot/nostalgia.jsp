...
<%
	...
	String imgSrcPage = "images/application/pages/index/page3/";
	...
	pageT.add(createBox(8, 739, 70, 240, 110, 240, 110, 0, 0, imgSrcTop + "status/c_f_nostalgia.png", imgSrcTop + "focus/f_nostalgia.png", false));
	...
	pageT.add(createBox(19, 542, 691, 193, 193, 221, 221, 0, 0, imgSrcPage + "193_193.png", imgSrcPage + "focus/f_221_221.png", false));
	pageT.add(createBox(20, 783, 691, 193, 193, 221, 221, 0, 0, imgSrcPage + "193_193.png", imgSrcPage + "focus/f_221_221.png", false));
	pageT.add(createBox(21, 1024, 691, 193, 193, 221, 221, 0, 0, imgSrcPage + "193_193.png", imgSrcPage + "focus/f_221_221.png", false));
	...
	List<Map<String, Object>> gabr = InfoData.getArtistsByRecommend(newPageA, nostalgiaAList, false);
		...
		<div id='realDis' style='position:absolute;width:<%=pageW %>px;height:<%=pageH %>px;overflow:hidden;display:none'>
			...
			<div id='BigDivFather' style='position:absolute;width:<%=pageW %>px;height:<%=pageH %>px;left:0px;top:0px;overflow:hidden'>
				<div id='BigDiv' style='position:absolute;width:<%=pageW %>px;height:<%=pageH %>px;left:0px;top:0px'>
					...
					<div style='position:absolute;width:150px;height:40px;left:60px;top:636px;font-size:30px;color:#FFFFFF;z-index:1'>天籁不老</div>
					<div style='position:absolute;width:150px;height:40px;left:60px;top:1154px;font-size:30px;color:#FFFFFF;z-index:1'>流金岁月</div>
					<div style='position:absolute;width:150px;height:40px;left:60px;top:1683px;font-size:30px;color:#FFFFFF;z-index:1'>粤语经典</div>
					<div style='position:absolute;width:150px;height:40px;left:60px;top:2209px;font-size:30px;color:#FFFFFF;z-index:1'>国语经典</div>
					<div style='position:absolute;width:150px;height:40px;left:60px;top:2736px;font-size:30px;color:#FFFFFF;z-index:1'>年代之声</div>
					<img src='images/application/pages/index/other/rtTop.png' style='position:absolute;width:159px;height:23px;left:556px;top:3030px;z-index:1' />
			...
			<script type='text/javascript' src='javascript/pages/nostalgia.js?r=<%=Math.random() %>'></script>
