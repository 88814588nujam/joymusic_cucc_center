...
<%
	...
	String rt = authResult211(userid, userToken, provinceN);
%>
<!DOCTYPE html>
<html lang='\"n'>
	<head>
		...
		<script type='text/javascript'>
			...
			function onkeyLeft(){
				if(allowClick){
					...
					if(tempF == 1) nowFocus = 'f_211_4';
					else if((tempF > 1 && tempF < 4) || (tempF > 14 && tempF < 17)){
						var newIdx = tempF - 1;
			...
			function onkeyUp(){
				if(allowClick){
					...
					else if(tempF == 9) nowFocus = 'f_211_2';
	...
	<body onload='start()' bgcolor='<%if(isOnline.equals("y")){%>#000000<%} else{%>#444444<%}%>'>
		<div id='realDis' style='position:absolute;width:<%=pageW %>px;height:<%=pageH %>px;overflow:hidden;display:none'>
			...
			<div id='BigDiv' style='position:absolute;width:<%=pageW %>px;height:<%=pageH %>px;left:0px;top:0px'>
				<img src='images/application/pages/zone_hall_211/vipback.png' style='position:absolute;width:186px;height:111px;left:63px;top:41px;z-index:1' />
				<img src='images/application/pages/zone_hall_211/force.png' style='position:absolute;width:278px;height:82px;left:264px;top:53px;z-index:1' />
				<img src='images/application/pages/zone_hall_211/if<%if(!rt.equals("0")){%>1<%}%>.png' style='position:absolute;width:139px;height:35px;left:101px;top:110px;z-index:2' />
				<img id='cp1' src='images/application/pages/zone_hall_211/null.png' style='position:absolute;width:205px;height:111px;left:569px;top:36px;z-index:1' />
				<img id='cp2' src='images/application/pages/zone_hall_211/null.png' style='position:absolute;width:205px;height:111px;left:789px;top:36px;z-index:1' />
				<img id='cp3' src='images/application/pages/zone_hall_211/null.png' style='position:absolute;width:205px;height:111px;left:1009px;top:36px;z-index:1' />
				<img id='pay1' src='images/application/pages/zone_hall_211/payhallnew<%if(!rt.equals("0")){%>1<%}%>.png' style='position:absolute;width:64px;height:63px;left:713px;top:36px;z-index:2' />
				<img id='pay2' src='images/application/pages/zone_hall_211/payhallnew<%if(!rt.equals("0")){%>1<%}%>.png' style='position:absolute;width:64px;height:63px;left:933px;top:36px;z-index:2' />
				<img id='pay3' src='images/application/pages/zone_hall_211/payhallnew<%if(!rt.equals("0")){%>1<%}%>.png' style='position:absolute;width:64px;height:63px;left:1153px;top:36px;z-index:2' />
				<img id='f_211_1' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_6.png' style='position:absolute;width:215px;height:121px;left:564px;top:31px;z-index:3' />
				<img id='f_211_2' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_6.png' style='position:absolute;width:215px;height:121px;left:784px;top:31px;z-index:3' />
				<img id='f_211_3' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_6.png' style='position:absolute;width:215px;height:121px;left:1004px;top:31px;z-index:3' /><%int left = 0; int top = 0; for(int i = 1; i < 6; i++){ top = (i - 1) * 46 + 216; left = 55;%>
