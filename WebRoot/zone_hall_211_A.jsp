		...
		<script type='text/javascript'>
						...
						if(xmlhttp.status == 200){
							...
							if(songArr.length > 0){
								for(var i = 0; i < songArr.length; i++){
									var idx = i + 1;
									$g('z_211_' + idx).innerText = songArr[i].cname + ' - ' + songArr[i].artist;
									if(i == songArr.length - 1) allowClick = true;
								}
							}
						}
					}
			...
			function onkeyLeft(){
				if(allowClick){
					...
					if((tempF > 1 && tempF < 4) || (tempF > 16 && tempF < 19)){
						var newIdx = tempF - 1;
						nowFocus = 'f_211_' + newIdx;
					} else if(tempF > 9 && tempF < 16){
						var newIdx = tempF - 6;
						nowFocus = 'f_211_' + newIdx;
					}
			...
			function onkeyRight(){
				if(allowClick){
					var tempF = getIdx(nowFocus, 'f_211_');
					$g(nowFocus).setAttribute('class', 'btn_focus_hidden');
					if((tempF > 0 && tempF < 3) || (tempF > 15 && tempF < 18)){
						var newIdx = tempF + 1;
						nowFocus = 'f_211_' + newIdx;
					} else if(tempF > 3 && tempF < 10){
						var newIdx = tempF + 6;
						nowFocus = 'f_211_' + newIdx;
					}
					var tempS = getIdx(nowFocus, 'f_211_');
			...
			function onkeyUp(){
				if(allowClick){
					...
					else if(tempF == 10) nowFocus = 'f_211_3';
					else if((tempF > 4 && tempF < 10) || (tempF > 10 && tempF < 16)){
						var newIdx = tempF - 1;
						nowFocus = 'f_211_' + newIdx;
					} else if(tempF == 16 || tempF == 17) nowFocus = 'f_211_9';
					else if(tempF == 18) nowFocus = 'f_211_15';
					var tempS = getIdx(nowFocus, 'f_211_');
					$g(nowFocus).setAttribute('class', 'btn_focus_visible');
					movePos('up');
				}
			...
			function onkeyDown(){
				if(allowClick){
					...
					else if(tempF == 3) nowFocus = 'f_211_10';
					else if((tempF > 3 && tempF < 9) || (tempF > 9 && tempF < 15)){
						var newIdx = tempF + 1;
						nowFocus = 'f_211_' + newIdx;
					} else if(tempF == 9) nowFocus = 'f_211_16';
					else if(tempF == 15) nowFocus = 'f_211_18';
					var tempS = getIdx(nowFocus, 'f_211_');
					$g(nowFocus).setAttribute('class', 'btn_focus_visible');
					movePos('down');
				}
			...
			function onkeyOK(){
				...
				} else if(tempF >= 4 && tempF < 16){
					var i = tempF - 4;
					toUrl = 'http://202.99.114.152:26800/joymusic_bs_tjlt/?boot=998_211_' + songArr[i].id + '&entryId=' + songArr[i].id;
					key = songArr[i].tsid;
				} else{
					var i = tempF - 13;
					toUrl = contentArr[i].curl;
	...
	<body onload='start()' bgcolor='<%if(isOnline.equals("y")){%>#000000<%} else{%>#444444<%}%>'>
		<div id='realDis' style='position:absolute;width:<%=pageW %>px;height:<%=pageH %>px;overflow:hidden;display:none'>
			...
			<div id='BigDiv' style='position:absolute;width:<%=pageW %>px;height:<%=pageH %>px;left:0px;top:0px'>
				<img src='images/application/pages/zone_hall_211/jxyy.png' style='position:absolute;width:142px;height:33px;left:61px;top:44px;z-index:1' />
				<img id='cp1' src='images/application/pages/zone_hall_211/370_205.png' style='position:absolute;width:370px;height:205px;left:60px;top:93px;z-index:1' />
				<img id='cp2' src='images/application/pages/zone_hall_211/370_205.png' style='position:absolute;width:370px;height:205px;left:454px;top:93px;z-index:1' />
				<img id='cp3' src='images/application/pages/zone_hall_211/370_205.png' style='position:absolute;width:370px;height:205px;left:848px;top:93px;z-index:1' />
				<img id='pay1' src='images/application/pages/zone_hall_211/pay<%if(!rt.equals("0")){%>1<%}%>.png' style='position:absolute;width:78px;height:81px;left:352px;top:93px;z-index:2' />
				<img id='pay2' src='images/application/pages/zone_hall_211/pay<%if(!rt.equals("0")){%>1<%}%>.png' style='position:absolute;width:78px;height:78px;left:746px;top:93px;z-index:2' />
				<img id='pay3' src='images/application/pages/zone_hall_211/pay<%if(!rt.equals("0")){%>1<%}%>.png' style='position:absolute;width:78px;height:78px;left:1140px;top:93px;z-index:2' />
				<img id='f_211_1' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_1.png' style='position:absolute;width:380px;height:216px;left:55px;top:88px;z-index:3' />
				<img id='f_211_2' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_1.png' style='position:absolute;width:380px;height:216px;left:449px;top:88px;z-index:3' />
				<img id='f_211_3' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_1.png' style='position:absolute;width:380px;height:216px;left:843px;top:88px;z-index:3' /><%int left = 0; int top = 0; for(int i = 1; i < 7; i++){ top = (i - 1) * 60 + 367; left = 55;%>
				<div id='z_211_<%=i %>' style='position:absolute;width:579px;height:64px;left:<%=left + 60 %>px;top:<%=top %>px;line-height:64px;font-size:24px;color:#FFFFFF;z-index:2'></div>
				<img id='f_211_<%=i + 3 %>' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_2.png' style='position:absolute;width:579px;height:64px;left:<%=left %>px;top:<%=top %>px;z-index:3' /><%left = 642;%>
				<div id='z_211_<%=i + 6 %>' style='position:absolute;width:579px;height:64px;left:<%=left + 60 %>px;top:<%=top %>px;line-height:64px;font-size:24px;color:#FFFFFF;z-index:2'></div>
				<img id='f_211_<%=i + 9 %>' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_2.png' style='position:absolute;width:579px;height:64px;left:<%=left %>px;top:<%=top %>px;z-index:3' /><%}%>
				<img src='images/application/pages/zone_hall_211/bz.png' style='position:absolute;width:570px;height:395px;left:59px;top:327px;z-index:1' />
				<img src='images/application/pages/zone_hall_211/ql.png' style='position:absolute;width:570px;height:395px;left:644px;top:327px;z-index:1' />
				...
				<img id='cp4' src='images/application/pages/zone_hall_211/370_210.png' style='position:absolute;width:370px;height:210px;left:60px;top:803px;z-index:1' />
				<img id='cp5' src='images/application/pages/zone_hall_211/370_210.png' style='position:absolute;width:370px;height:210px;left:454px;top:803px;z-index:1' />
				<img id='cp6' src='images/application/pages/zone_hall_211/370_210.png' style='position:absolute;width:370px;height:210px;left:848px;top:803px;z-index:1' />
				<img id='f_211_16' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_3.png' style='position:absolute;width:381px;height:221px;left:55px;top:798px;z-index:2;' />
				<img id='f_211_17' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_3.png' style='position:absolute;width:381px;height:221px;left:449px;top:798px;z-index:2' />
				<img id='f_211_18' class='btn_focus_hidden' src='images/application/pages/zone_hall_211/focus/f_3.png' style='position:absolute;width:381px;height:221px;left:843px;top:798px;z-index:2' />
			</div>
		</div>
	</body>
	<script type='text/javascript'>
