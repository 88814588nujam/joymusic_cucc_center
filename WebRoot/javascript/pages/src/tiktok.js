			...
			function loadContent(start, end, idx){
				if(!loadFlag[idx]){
					...
					for(var i = start; i <= end; i++){
						var realIdx = i - 1;
						$g('pic_' + i).src = 'images/commonly/recommend/page4/' + jsonRec[realIdx].pic;
			...
			function onkeyLeft(){
				if(allowClick){
					...
					if((tempF > 1 && tempF < 5) || (tempF > 5 && tempF < 10) || (tempF > 10 && tempF < 13) || (tempF > 13 && tempF < 17) || (tempF > 17 && tempF < 22)
						...
						|| (tempF > 37 && tempF < 40) || (tempF > 40 && tempF < 43)){
						var newIdx = tempF - 1;
			...
			function onkeyRight(){
				if(allowClick){
					...
					if((tempF > 0 && tempF < 4) || (tempF > 4 && tempF < 9) || (tempF > 9 && tempF < 12) || (tempF > 12 && tempF < 16) || (tempF > 16 && tempF < 21)
						...
						|| (tempF > 36 && tempF < 39) || (tempF > 39 && tempF < 42)){
						var newIdx = tempF + 1;
						nowFocus = 'f_index_' + newIdx;
					} else{
						// 天津河南有多余的按键
			...
			function onkeyUp(){
				if(allowClick){
					...
					else if(tempF == 10 || tempF == 11 || tempF == 12) nowFocus = 'f_index_9';
			...
			function onkeyDown(){
				if(allowClick){
					...
					$g(nowFocus).setAttribute('class', 'btn_focus_hidden');
					if(tempF < 10) $g('index_' + tempF).style.visibility = 'visible';
					if(tempF > 0 && tempF < 5) nowFocus = 'f_index_9';
