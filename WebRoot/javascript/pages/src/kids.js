			function start(){
				...
				loadContent(1, 6, 0);
				if(backPos == 0){
					$g('index_12').src = 'images/application/pages/index/commonly/null.png';
					playNext(stbPos[0], stbPos[1], stbPos[2], stbPos[3], 0);
				} else $g('index_12').src = 'images/application/pages/index/page2/window.png';
				followWords(1);
			...
			function loadContent(start, end, idx){
				if(!loadFlag[idx]){
					...
					for(var i = start; i <= end; i++){
						var realIdx = i - 1;
						$g('pic_' + i).src = 'images/commonly/recommend/page2/' + jsonRec[realIdx].pic;
			...
			function onkeyOK(){
				if(allowClick){
					...
					if(tempF == 0){
						...
						var listIdx = 10008;
						if(tempF == 18) listIdx = 10009;
						else if(tempF == 19) listIdx = 10010;
						else if(tempF == 20) listIdx = 10011;
						else if(tempF == 21) listIdx = 10012;
						put('request', 'params', 'i=' + toPageId + '&k=' + listIdx);
						...
						addToBack(nowInfo);
						toOtrPage(tempF, toPageId, listIdx);
					} else{
			...
			function onkeyLeft(){
				if(allowClick){
					...
					if((tempF > 1 && tempF < 5) || (tempF > 5 && tempF < 10) || (tempF > 10 && tempF < 13) || (tempF > 13 && tempF < 17) || (tempF > 17 && tempF < 22)
						|| (tempF > 22 && tempF < 25) || (tempF > 25 && tempF < 29) || (tempF > 29 && tempF < 33) || (tempF > 33 && tempF < 36) || (tempF > 36 && tempF < 39)
						|| (tempF > 39 && tempF < 44) || (tempF > 44 && tempF < 47) || (tempF > 47 && tempF < 50)){
						var newIdx = tempF - 1;
			...
			function onkeyRight(){
				if(allowClick){
					...
					if((tempF > 0 && tempF < 4) || (tempF > 4 && tempF < 9) || (tempF > 9 && tempF < 12) || (tempF > 12 && tempF < 16) || (tempF > 16 && tempF < 21)
						|| (tempF > 21 && tempF < 24) || (tempF > 24 && tempF < 28) || (tempF > 28 && tempF < 32) || (tempF > 32 && tempF < 35) || (tempF > 35 && tempF < 38)
						|| (tempF > 38 && tempF < 43) || (tempF > 43 && tempF < 46) || (tempF > 46 && tempF < 49)){
						var newIdx = tempF + 1;
						nowFocus = 'f_index_' + newIdx;
					} else{
						// 天津河南有多余的按键
			...
			function onkeyUp(){
				if(allowClick){
					...
					else if(tempF == 10 || tempF == 11 || tempF == 12) nowFocus = 'f_index_7';
					else if(tempF == 13) nowFocus = 'f_index_10';
					else if(tempF == 14) nowFocus = 'f_index_11';
					else if(tempF == 15 || tempF == 16) nowFocus = 'f_index_12';
					else if(tempF == 17 || tempF == 18) nowFocus = 'f_index_13';
					else if(tempF == 19) nowFocus = 'f_index_14';
					else if(tempF == 20) nowFocus = 'f_index_15';
					...
					else if(tempF == 25 || tempF == 26) nowFocus = 'f_index_22';
					else if(tempF == 27) nowFocus = 'f_index_23';
					else if(tempF == 28) nowFocus = 'f_index_24';
					else if(tempF == 29) nowFocus = 'f_index_25';
					else if(tempF == 30) nowFocus = 'f_index_27';
					else if(tempF == 31 || tempF == 32) nowFocus = 'f_index_28';
					else if(tempF == 33) nowFocus = 'f_index_29';
					else if(tempF == 34) nowFocus = 'f_index_30';
					else if(tempF == 35) nowFocus = 'f_index_32';
					else if(tempF == 39 || tempF == 40) nowFocus = 'f_index_36';
					else if(tempF == 41) nowFocus = 'f_index_37';
					else if(tempF == 42 || tempF == 43) nowFocus = 'f_index_38';
					else if(tempF == 44) nowFocus = 'f_index_39';
					else if(tempF == 45) nowFocus = 'f_index_41';
					else if(tempF == 46) nowFocus = 'f_index_43';
					else if((tempF > 35 && tempF < 39) || (tempF > 46 && tempF < 50)){
						var newIdx = tempF - 3;
						nowFocus = 'f_index_' + newIdx;
					}
					movePos('up');
			...
			function onkeyDown(){
				if(allowClick){
					...
					$g(nowFocus).setAttribute('class', 'btn_focus_hidden');
					if(tempF < 10) $g('index_' + tempF).style.visibility = 'visible';
					if(tempF > 0 && tempF < 5) nowFocus = 'f_index_7';
					else if(tempF == 5 || tempF == 6) nowFocus = 'f_index_10';
					else if(tempF == 7) nowFocus = 'f_index_11';
					else if(tempF == 8 || tempF == 9) nowFocus = 'f_index_12';
					else if(tempF == 10) nowFocus = 'f_index_13';
					else if(tempF == 11) nowFocus = 'f_index_14';
					else if(tempF == 12) nowFocus = 'f_index_15';
					else if(tempF == 13) nowFocus = 'f_index_17';
					else if(tempF == 14) nowFocus = 'f_index_19';
					else if(tempF == 15) nowFocus = 'f_index_20';
					...
					else if(tempF == 22) nowFocus = 'f_index_25';
					else if(tempF == 23) nowFocus = 'f_index_27';
					else if(tempF == 24) nowFocus = 'f_index_28';
					else if(tempF == 25 || tempF == 26) nowFocus = 'f_index_29';
					else if(tempF == 27) nowFocus = 'f_index_30';
					else if(tempF == 28) nowFocus = 'f_index_32';
					else if(tempF == 29) nowFocus = 'f_index_33';
					else if(tempF == 30) nowFocus = 'f_index_34';
					else if(tempF == 31 || tempF == 32) nowFocus = 'f_index_35';
					else if(tempF == 36) nowFocus = 'f_index_39';
					else if(tempF == 37) nowFocus = 'f_index_41';
					else if(tempF == 38) nowFocus = 'f_index_43';
					else if(tempF == 39 || tempF == 40) nowFocus = 'f_index_44';
					else if(tempF == 41) nowFocus = 'f_index_45';
					else if(tempF == 42 || tempF == 43) nowFocus = 'f_index_46';
					else if((tempF > 32 && tempF < 36) || (tempF > 43 && tempF < 47)){
						var newIdx = tempF + 3;
						nowFocus = 'f_index_' + newIdx;
					} else{
						// 天津河南有多余的按键
					...
					if(tempS < 10) $g('index_' + tempS).style.visibility = 'hidden';
					$g(nowFocus).setAttribute('class', 'btn_focus_visible');
					if(tempS > 16 && tempS < 22) loadContent(7, 9, 1);
					else if(tempS > 21 && tempS < 25) loadContent(10, 17, 2);
					else if(tempS > 28 && tempS < 33) loadContent(18, 23, 3);
					else if(tempS > 35 && tempS < 39) loadContent(24, 28, 4);
					else if(tempS > 38 && tempS < 44) loadContent(29, 34, 5);
					displayBack();
					followWords(1);
				}
			}
			...
			function displayBack(){
				...
				if(tempS < 13){
					...
					if(timesIn){
						try{
							$g('index_12').src = 'images/application/pages/index/page1/window.png';
							destoryMP();
						} catch(e){}
					}
				}
